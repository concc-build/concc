...
export CARGO_HOME=/home/concc/.cargo
...
echo "Creating the Cargo home..."
gosu concc mkdir -p $CARGO_HOME
...
do
  ...
  echo "$WORKER: Mounting the Cargo home..."
...
gosu concc cargo build --release -j $JOBS
